...
// Get all profiles
export const getAllProfiles = () => async (dispatch: any) => {
...
// Get profile by ID
export const getProfileById = (id: any) => async (dispatch: any) => {
  try {
    const res = await axios.get('/api/v1/profiles/user/' + id);
...
// Get github repos
export const getProfileGithub = (username: any) => async (dispatch: any) => {
  try {
